...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.9.0/llmtrimFFI.xcframework.zip",
            checksum: "b1d5bdd40e4a1d036073cf832398b9cabf589edd531f8e4ee4c97596ff27653a"
        ),
        .target(
            name: "Llmtrim",
