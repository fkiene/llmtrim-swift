...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.3.2/llmtrimFFI.xcframework.zip",
            checksum: "cbfe47fdb0f4fc27e590334c503ae956a60e6099d55241ea7b772e70437ac125"
        ),
        .target(
            name: "Llmtrim",
