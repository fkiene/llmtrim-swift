...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.10.2/llmtrimFFI.xcframework.zip",
            checksum: "82dfc3d5cb2c302af53dddf3f100e073fd8c4be2de008ac7fe0049d8985d661c"
        ),
        .target(
            name: "Llmtrim",
