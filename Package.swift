...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.2.1/llmtrimFFI.xcframework.zip",
            checksum: "0c4362316e1f9c1b8d68ea1ecbe8eaef69423643172b66ea43b48f0203c80fa1"
        ),
        .target(
            name: "Llmtrim",
