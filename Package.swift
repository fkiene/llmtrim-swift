...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.12.3/llmtrimFFI.xcframework.zip",
            checksum: "6f6c4b8d650c81756f7f0dc69f1fbaad4792892eb49660f476959e0af15fbca1"
        ),
        .target(
            name: "Llmtrim",
