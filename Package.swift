...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.3.1/llmtrimFFI.xcframework.zip",
            checksum: "ffa8abbbb2af808816633d75b8b3263f8008199b7e228da089ad05cd6b4f2ae4"
        ),
        .target(
            name: "Llmtrim",
