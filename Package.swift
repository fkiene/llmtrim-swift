...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.11.4/llmtrimFFI.xcframework.zip",
            checksum: "d2046c9ff2361f282c69ad7848c9b6aec73914e23c9835c7c6165f26ed6ffb24"
        ),
        .target(
            name: "Llmtrim",
