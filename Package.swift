...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.6.3/llmtrimFFI.xcframework.zip",
            checksum: "9c2b524a82ed2bda7144601b60105be6902f719e79ebbf779e2cf0216d23eff0"
        ),
        .target(
            name: "Llmtrim",
