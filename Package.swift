...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.9.2/llmtrimFFI.xcframework.zip",
            checksum: "03bc64cbd80e35797a217b7f8cd497cbb1f700321f090977e5f5c033a5bd7aa9"
        ),
        .target(
            name: "Llmtrim",
