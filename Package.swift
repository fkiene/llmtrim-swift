...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.12.5/llmtrimFFI.xcframework.zip",
            checksum: "f14fa068b16647243a218e07d48b7bfb037e43ec3ee2131ab64c652cf64f43f7"
        ),
        .target(
            name: "Llmtrim",
