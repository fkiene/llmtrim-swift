...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.9.4/llmtrimFFI.xcframework.zip",
            checksum: "36d311196e8b0d73f74f971d0258899a5274d1d50d886ae21508aadb3481de09"
        ),
        .target(
            name: "Llmtrim",
