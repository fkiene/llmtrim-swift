...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.1.8/llmtrimFFI.xcframework.zip",
            checksum: "b9f21e33d1e40cefd6f332ce3e1d688a44fd24c5d67f8adc883d60b8df20238c"
        ),
        .target(
            name: "Llmtrim",
