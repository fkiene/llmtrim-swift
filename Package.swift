...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.6.0/llmtrimFFI.xcframework.zip",
            checksum: "6e1769b0eeb93bf6dab3351b70f949bb6fcf8a9272b94e8266f622eb20261760"
        ),
        .target(
            name: "Llmtrim",
