...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.12.1/llmtrimFFI.xcframework.zip",
            checksum: "d8daa42815bcfa90efa0f190d61902db8458e3de4558a0327e39be254e02547b"
        ),
        .target(
            name: "Llmtrim",
