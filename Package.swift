...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.9.1/llmtrimFFI.xcframework.zip",
            checksum: "bf102f3cfe91c3c69880de5b0cf46aa0145a97b70901989d25684da52ac659e1"
        ),
        .target(
            name: "Llmtrim",
