...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.11.2/llmtrimFFI.xcframework.zip",
            checksum: "3b85f98a8f1f28792a49b3a5bb59f96ac73704f51d5352cee7f20039337d741a"
        ),
        .target(
            name: "Llmtrim",
