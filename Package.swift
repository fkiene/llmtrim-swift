...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.13.1/llmtrimFFI.xcframework.zip",
            checksum: "00296528a71fb812c8218090c0c8324880279a25477a899b0761a3e39d3270e5"
        ),
        .target(
            name: "Llmtrim",
