...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.1.11/llmtrimFFI.xcframework.zip",
            checksum: "4be5f0e694077a5a030406f6cd0c410280081a0852cbf7e29db9e5e02dcccb13"
        ),
        .target(
            name: "Llmtrim",
