...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.11.1/llmtrimFFI.xcframework.zip",
            checksum: "d500a4785d8e38c4618a3dadc0cec19847f5a17cec9a5a9f4c6d941410996b01"
        ),
        .target(
            name: "Llmtrim",
