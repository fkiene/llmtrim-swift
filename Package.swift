...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.11.3/llmtrimFFI.xcframework.zip",
            checksum: "b3a60e91bc0a4c8a23802bbde490453adec44f13f0bfdc1be65b3ffeadd18b5e"
        ),
        .target(
            name: "Llmtrim",
