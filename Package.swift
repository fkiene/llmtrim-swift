...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "llmtrimFFI",
            url: "https://github.com/fkiene/llmtrim/releases/download/v0.4.0/llmtrimFFI.xcframework.zip",
            checksum: "2c199d318c04a863805c36886b62906f6db7fb29198caf0b50cf8aee72cb543c"
        ),
        .target(
            name: "Llmtrim",
